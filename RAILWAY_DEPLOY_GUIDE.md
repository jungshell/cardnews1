...
Railway 무료 플랜은 프로젝트 생성 개수에 제한이 있습니다.

### 해결 방법: 기존 프로젝트에 서비스 추가
1. 기존 프로젝트 선택 (예: `gallant-acceptance`)
2. 프로젝트 페이지에서 **"+ New"** 클릭
3. **"GitHub Repo"** 선택
4. `jungshell/cardnews1` 저장소 연결
5. 나머지는 아래 가이드와 동일하게 진행

**또는** `RAILWAY_ALTERNATIVE_GUIDE.md` 파일에서 다른 무료 플랫폼 옵션 확인
